...
| 2D | Z-axis (measured / simulated parameters) | z_vrms_(uV), z_pop_(%) | Readout voltages / state probabilities representing the $\|1\rangle$ state population (e.g., $\text{P}_{\|11\rangle}$, $\text{P}_{\|1\rangle}$ ADC-I ($\mu\text{V}$)). |
